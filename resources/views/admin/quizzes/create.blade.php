        ...
        <form method="POST" action="{{ route('admin.quizzes.store') }}">
            ...
            <div class="mb-5">
                ...
                <textarea id="description" name="description" rows="4" 
                    ...
                    placeholder="Provide a brief description of the quiz contents or topics.">{{ old('description') }}</textarea>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="mb-5 flex items-center pt-8">
                    ...
                    <x-input-label for="is_published" :value="__('Publish Quiz Immediately')" class="ml-2 text-sm text-gray-600" />
